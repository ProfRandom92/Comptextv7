...
`evidence_survival_rate`, `evidence_survived`, and `evidence_total` in the
in-memory replay rows and JSON artifacts.
...
metrics while also tracking evidence preservation explicitly.
